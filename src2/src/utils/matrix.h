...
namespace Matrix {
    ...
    template <class Type> std::vector<Type> create_1d_matrix(size_t size, Type value) {
    ...
    template<class Real_t> void normalize_1d_matrix_elements(std::vector<Real_t> &matrix) {
